...
class ProductDataTable extends DataTable
{
    ...
    protected function getColumns()
    {
        return [
            ...
            'logo' => new Column(['title' => __('models/products.fields.logo'), 'data' => 'logo']),
            'status' => new Column(['title' => __('models/products.fields.status'), 'data' => 'status']),
            'price' => new Column(['title' => __('models/products.fields.price'), 'data' => 'price']),
            'cost' => new Column(['title' => __('models/products.fields.cost'), 'data' => 'cost']),
            'qty' => new Column(['title' => __('models/products.fields.qty'), 'data' => 'qty']),
