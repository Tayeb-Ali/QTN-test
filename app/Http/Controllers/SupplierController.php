...
class SupplierController extends AppBaseController
{
    ...
    public function store(CreateSupplierRequest $request)
    {
        ...
        Flash::success(__('lang.saved_successfully', ['model' => __('models/suppliers.singular')]));
    ...
    public function show($id)
    {
        ...
        if (empty($supplier)) {
            Flash::error(__('models/suppliers.singular').' '.__('lang.not_found'));
    ...
    public function edit($id)
    {
        ...
        if (empty($supplier)) {
            Flash::error(__('lang.not_found', ['model' => __('models/suppliers.singular')]));
    ...
    public function update($id, UpdateSupplierRequest $request)
    {
        ...
        Flash::success(__('lang.updated_successfully', ['model' => __('models/suppliers.singular')]));
    ...
    public function destroy($id)
    {
        ...
        Flash::success(__('lang.deleted_successfully', ['model' => __('models/suppliers.singular')]));
