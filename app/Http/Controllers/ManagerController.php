...
class ManagerController extends AppBaseController
{
    ...
    public function store(CreateManagerRequest $request)
    {
        ...
        Flash::success(__('lang.saved_successfully', ['model' => __('models/managers.singular')]));
    ...
    public function show($id)
    {
        ...
        if (empty($manager)) {
            Flash::error(__('models/managers.singular').' '.__('lang.not_found'));
    ...
    public function edit($id)
    {
        ...
        if (empty($manager)) {
            Flash::error(__('lang.not_found', ['model' => __('models/managers.singular')]));
    ...
    public function update($id, UpdateManagerRequest $request)
    {
        ...
        Flash::success(__('lang.updated_successfully', ['model' => __('models/managers.singular')]));
    ...
    public function destroy($id)
    {
        ...
        Flash::success(__('lang.deleted_successfully', ['model' => __('models/managers.singular')]));
